def evaluate_expression(ast, environment):
    ...
    # MODULUS OPERATOR ADDITIONS ========================================================

    # check for AST with root '%'
    if ast["tag"] == "%":
        ...
        # return the % operation result and the environment
        return left_value % right_value, environment
...
def evaluate_statement(ast, environment):
    ...
    # handles AST with root 'repeat'
    if ast["tag"] == "repeat":

        #assign initial condition and environment
        condition, environment = evaluate_expression(ast["condition"], environment)
...
def test_evaluate_modulus_by_zero():
...
def test_evaluate_repeat_statement():
    print("test evaluate repeat statement.")
    equals("repeat {x = x + 1;} until (x == 5)", {"x":0}, None, {"x":5})
    # make sure it does at least once
    equals("repeat {y = y - 1;} until (1)", {"y":5}, None, {"y":4}) 
...
if __name__ == "__main__":
    ...
    # REPEAT-UNTIL LOOP ADDITIONS =================================================
    test_evaluate_repeat_statement()
    # =============================================================================
